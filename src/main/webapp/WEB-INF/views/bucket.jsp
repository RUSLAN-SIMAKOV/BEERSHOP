    ...
    <table border="2">
        ...
        <c:forEach var="item" items="${items}">
            <tr>
                ...
                <td>
                    <a href="/beershop_war_exploded/servlet/deleteItemFromBucket?item_id=${item.id}">DELETE</a>
                </td>
            </tr>
        </c:forEach>
    </table>
    <br>
    <form action="${pageContext.request.contextPath}/servlet/showOrder" class="form-control">
